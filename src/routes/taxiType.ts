...
import { createTaxiType, deleteTaxiType, getAllTaxiType, getTaxiTypeById, updateTaxiType } from '../controllers/taxiType';
...
router.get('/', checkAuthorizationMiddleware, getAllTaxiType);
