...
const pointPromotion_1 = require("../controllers/pointPromotion"); // Ensure this file exists and is correctly named
const middlewares_1 = require("../middlewares");
const router = express_1.default.Router();
router.post("/", middlewares_1.checkAuthorizationMiddleware, pointPromotion_1.createPointPromotion);
