...
const getAllLoyaltyService = (skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const total = yield loyalty_1.loyaltyModel.countDocuments();
        const Loyalties = yield loyalty_1.loyaltyModel.find()
            .skip(skip)
            .limit(limit)
            .sort({ createdAt: -1 });
