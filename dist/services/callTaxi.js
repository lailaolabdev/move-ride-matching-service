...
const getDriverPaymentDetailService = (callTaxiId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const driverPayment = yield callTaxi_1.CallTaxi.aggregate([
            {
                $match: {
                    _id: new mongoose_1.default.Types.ObjectId(callTaxiId)
                }
            },
            {
                $project: {
